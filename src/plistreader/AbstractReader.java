 ...
 * 
 * <p>
 * This abstract class can be used to parse a <code>PLIST</code> file. The main function is hence <code>parse()</code>. That function needs a specified file and
 * a specified handler to function. These can be specified using the constructor(s) or the other setting functions like <code>setFile</code> and
...
public abstract class AbstractReader {
	...
	/**
	 * Holds the file to read, needs to be specified in the constructor or the <code>setFile</code> function.
	 * 
	...
	public PlistProperties parse(File _file) throws PlistReaderException {
		setFile(_file);
		return parse();
	}
